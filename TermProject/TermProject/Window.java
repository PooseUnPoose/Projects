...
public class Window extends JPanel {
    ...
    public static int OverallPscore = 0; //These were added after the presentation
    public static int OverallCscore = 0; //These were added after the presentation
...
public Window() { 
    ...
    Overallscores = new JLabel("Round wins: Player: " + OverallPscore + "  Computer: " + OverallCscore);//Added after presentation
    SkipButton = new JButton ("Skip Card");
    Reset = new JButton("Reset Game"); //Added after presentation
    ...
    //This was added after the presentation
    Reset.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
            ...
            PlayerCard1.setIcon(new ImageIcon("TermProject/Cards/CardBack.jpg"));
            PlayerCard2.setIcon(new ImageIcon("TermProject/Cards/CardBack.jpg"));
            PlayerCard3.setIcon(new ImageIcon("TermProject/Cards/CardBack.jpg"));
            PlayerCard4.setIcon(new ImageIcon("TermProject/Cards/CardBack.jpg"));
            PlayerCard5.setIcon(new ImageIcon("TermProject/Cards/CardBack.jpg"));
            NpcCard1.setIcon(new ImageIcon("TermProject/Cards/CardBack.jpg"));
            NpcCard2.setIcon(new ImageIcon("TermProject/Cards/CardBack.jpg"));
            NpcCard3.setIcon(new ImageIcon("TermProject/Cards/CardBack.jpg"));
            NpcCard4.setIcon(new ImageIcon("TermProject/Cards/CardBack.jpg"));
            NpcCard5.setIcon(new ImageIcon("TermProject/Cards/CardBack.jpg"));
            PlayerScore.setText("Player Score: ");
            NpcScore.setText("Computer Score: ");
            PScore = 0;
            CScore = 0;
            PopupShown = false;
            Overallscores.setText("Round wins: Player: " + OverallPscore + "  Computer: " + OverallCscore);
        }
    });
...
//set component bounds (only needed by Absolute Positioning)
    ...
    Overallscores.setBounds(425, 20, 250, 35);
    Reset.setBounds (465, 640, 110, 35);
